...
func (c *Controller) ourClass(ing *netv1beta1.Ingress) bool {
...
func (c *Controller) setupIngProcess() error {
	...
	c.ingProc = makeProcessor(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return c.client.NetworkingV1beta1().Ingresses(metav1.NamespaceAll).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				options.LabelSelector = c.selector.String()
				return c.client.NetworkingV1beta1().Ingresses(metav1.NamespaceAll).Watch(options)
			},
		},
		&netv1beta1.Ingress{},
		c.refresh,
	...
	c.ingList = listnetv1beta1.NewIngressLister(c.ingProc.informer.GetIndexer())
